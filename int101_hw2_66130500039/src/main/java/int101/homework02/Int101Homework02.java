...
public class Int101Homework02 {
    ...
    Utilitor.testString("asd");
    Utilitor.computeIsbn10(212155);
    Person person = new Person("thanaphum","saniwong");
    Account d = new Account(person);
    Account c = new Account(person);
    d.deposit(10000);
    d.transfer(5000,c);
